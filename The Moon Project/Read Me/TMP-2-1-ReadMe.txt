...
Insert the "The Moon Project" CD into your CD-ROM drive. When the 
...
adversely affected if the host machine is running The Moon  
Project at a very high resolution. Adding AI players may also 
...
Video Card Issues
The Moon Project should run well on almost any Direct3D (Windows 
...
custom cursors while playing The Moon Project.

If your system has two or more video cards and you use windowed 
mode, The Moon Project may appear on the wrong monitor. Whenever 
...
3dfx Video Cards
When playing The Moon Project with a video card using any 
...
playing The Moon Project. Task switching can cause The Moon 
Project to lock up and require you to restart your computer.
...
A map editor is included with The Moon Project. It is an 
