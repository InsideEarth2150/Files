...
rem =====================================================================
rem  InsideEarth - Earth 2150 Levels Downloader.
rem  Double-click this file. It fetches the latest setup script from
rem  GitHub and runs it.
rem =====================================================================

title InsideEarth - Earth 2150 Levels Downloader

:: Fixed ESC capture (removed space before the pipe)
for /F "delims=" %%a in ('echo prompt $E^|cmd') do set "ESC=%%a"

echo %ESC%[92m ===================================================%ESC%[0m
echo %ESC%[92m   InsideEarth - Earth 2150 Levels Downloader%ESC%[0m
echo %ESC%[92m ===================================================%ESC%[0m
echo.
