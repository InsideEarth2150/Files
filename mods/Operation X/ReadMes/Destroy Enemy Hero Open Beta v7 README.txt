"Destroy Enemy Hero Open Beta v7" Gametype v029  released 2008-DEC-03

===============================================================================================
This gametype adds a special "Hero Unit" at the game launch to the standard mining gameplay. If this unit is destoyed you loose.
The Hero Unit's movement is restricted to 30 spaces from the starting position for the first 10 minutes of the game to disable any attempt to use said hero to "rush" an opponent.
...
For this mod the original 'DES' options have been set as standard default values except for the victory condition.
Gaining Money:		Mine for Money
Victory Conditions:	Destroy Enemy Heros
...
SPECIAL HERO
[Choices are: LC Electro-Plasma|ED Laser-Laser|UCS Plasma-Plasma|By Race]
This option allows the host to chose the identical Special Hero for all players or instead the player's Special Hero is determined by the player's race.
...
CHANGELOG
=========
v024-- Bug fix to correct crash if Hero was using SF3 unit script
v025-- v5 release
v028-- v6 release, Team dropdown changed, Auto Ally: during auto ally the confirmation for ally is now randomized, Special Hero now Selectable by host.
v029-- v7 release, more team options, 3v1, 4v1 etc.
===============================================================================================
