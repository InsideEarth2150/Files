...
2007-DEC-01 original release 3.0
2008-DEC-03 updated
...
The SF Civil allows for SPECIAL LIGHTS option.

The SF Supplier allows for SPECIAL LIGHTS option.

The SF Minelaer allows for improved minelaying under the Mine 100% option.
...
1) The FRONT LINE feature. (Now only available for AIR units) It is a way to align and position your units. When activated all SELECTED units stop, then move up to a line facing in same direction similar to platoon behavior. Air units will tend to make a vertical wall.
...
Changelog:
Builder 302	- removed ability to record buildings and then transfer builder to an ally during build
Tank 318	- removed Frontline
