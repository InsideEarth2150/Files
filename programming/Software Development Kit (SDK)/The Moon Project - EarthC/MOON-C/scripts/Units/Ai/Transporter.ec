...
multi:
    ...
    //-------------------------------------------------------
    command Land() hidden button "translateCommandLand" description "translateCommandLandDescription" hotkey priority 31 
    {
        SetUnitToTransport(null);
        CallLand();
        NextCommand(1);
    ...
    //-------------------------------------------------------
    command TransporterPutUnit() hidden button "translateCommandTransporterPutUnit" description "translateCommandTransporterPutUnitDescription" hotkey priority 102
    {
        if (HaveUnitOnHook())
        {
            if (IsHelicopter())
    ...
    //-------------------------------------------------------
    command TransporterPutUnitToPoint(int nX, int nY, int nZ) hidden button "translateCommandTransporterPutUnitToPoint" description "translateCommandTransporterPutUnitToPointDescription" hotkey priority 103
    {
        if (HaveUnitOnHook())
        {
            m_nPutPosX = nX;
    ...
    //-------------------------------------------------------
    command TransporterDropUnit() hidden button "translateCommandTransporterDropUnit" description "translateCommandTransporterDropUnitDescription" hotkey priority 105
    {
    ...
    //-------------------------------------------------------
    command TransporterDropUnitToPoint(int nX, int nY, int nZ) hidden button "translateCommandTransporterDropUnitToPoint" description "translateCommandTransporterDropUnitToPointDescription" hotkey priority 106
    {
        if (HaveUnitOnHook() && IsHelicopter())
        {
            m_nPutPosX = nX;
    ...
    //-------------------------------------------------------
    command TransporterSetTransportMode(int nMode) hidden button transporterMode description "translateCommandTransporterSetModeDescription" hotkey priority 210
    {
        if (nMode == -1)
        {
    ...
    //-------------------------------------------------------
    command TransporterSetAutoGetPoint(int nX, int nY, int nZ) hidden button "translateCommandTransporterSetAutoGetPoint" description "translateCommandTransporterSetAutoGetPointDescription" hotkey priority 211
    {
        m_nAutoGetPointX = nX;
        m_nAutoGetPointY = nY;
        m_nAutoGetPointZ = nZ;
    ...
    //-------------------------------------------------------
    command TransporterSetAutoPutPoint(int nX, int nY, int nZ) hidden button "translateCommandTransporterSetAutoPutPoint" description "translateCommandTransporterSetAutoPutPointDescription" hotkey priority 212
    {
        m_nAutoPutPointX = nX;
        m_nAutoPutPointY = nY;
        m_nAutoPutPointZ = nZ;
    ...
    //-------------------------------------------------------
    command SpecialShowTransporterAutoGetPoint() hidden button "translateCommandShowTransporterAutoGetPoint" description "translateCommandShowTransporterAutoGetPointDescription" hotkey priority 213
    {
        //special command - no implementation
    }
    //-------------------------------------------------------
    command SpecialShowTransporterAutoPutPoint() hidden button "translateCommandShowTransporterAutoPutPoint" description "translateCommandShowTransporterAutoPutPointDescription" hotkey priority 214
    {
        //special command - no implementation
    }
    //-------------------------------------------------------
