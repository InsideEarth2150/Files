mission "translateMission171"
{
    ...
    state Initialize
    {
        ...
        RegisterGoal(sendToBase,"translateGoal171",nNeedeResources,0);
    ...
    state ShowBriefing
    {
        AddBriefing("translateBriefing171",nNeedeResources);
        return Mining,200; 
    }
    //-----------------------------------------------------------------------------------------
    state Mining
    ...
    {
        RegisterGoal(sendToBase,"translateGoal171",nNeedeResources,p_Player.GetMoneySentToBase());
