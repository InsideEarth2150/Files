mission "translateMission371"
{
    ...
    state Initialize
    {
        ...
        RegisterGoal(sendToBase,"translateGoal371",nNeedeResources,0);
    ...
    state ShowBriefing
    {
        AddBriefing("translateBriefing371",pPlayer.GetName(),nNeedeResources);
        return Mining,200; 
    }
    //-----------------------------------------------------------------------------------------
    state Mining
    ...
    {
        RegisterGoal(sendToBase,"translateGoal371",nNeedeResources,pPlayer.GetMoneySentToBase());
